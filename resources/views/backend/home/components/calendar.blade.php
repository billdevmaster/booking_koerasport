...
<div id="calendar"></div>
<input type="hidden" id="next_start_date" value="{{ date("Y-m-d", strtotime($start_date. ' + 1 days')) }}">
<input type="hidden" id="prev_start_date" value="{{ date("Y-m-d", strtotime($start_date. ' - 1 days')) }}">
